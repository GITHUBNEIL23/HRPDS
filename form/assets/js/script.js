...
let Father_Surname = document.getElementById('Father_Surname');
let Father_Firstname = document.getElementById('Father_Firstname');
let Father_NameExtension = document.getElementById('Father_NameExtension');
let Father_Middlename = document.getElementById('Father_Middlename');
let Mother_MaidenName = document.getElementById('Mother_MaidenName');
let Mother_Surname = document.getElementById('Mother_Surname');
let Mother_Firstname = document.getElementById('Mother_Firstname');
let Mother_Middlename = document.getElementById('Mother_Middlename');

let Spouse_Children = [];

let NOF_Elementary = document.getElementById('NOF_Elementary');
let NOF_Secondary = document.getElementById('NOF_Secondary');
let NOF_Vocational = document.getElementById('NOF_Vocational');
let NOF_College = document.getElementById('NOF_College');
let NOF_Graduate = document.getElementById('NOF_Graduate');
let BE_D_C_Elementary = document.getElementById('BE_D_C_Elementary');
let BE_D_C_Secondary = document.getElementById('BE_D_C_Secondary');
let BE_D_C_Vocational = document.getElementById('BE_D_C_Vocational');
let BE_D_C_College = document.getElementById('BE_D_C_College'); 
let BE_D_C_Graduate = document.getElementById('BE_D_C_Graduate');
let POA_From_Elementary = document.getElementById('POA_From_Elementary');
let POA_To_Elementary = document.getElementById('POA_To_Elementary');
let POA_From_Secondary = document.getElementById('POA_From_Secondary');
let POA_To_Secondary = document.getElementById('POA_To_Secondary');
let POA_From_Vocational = document.getElementById('POA_From_Vocational');
let POA_To_Vocational = document.getElementById('POA_To_Vocational');
let POA_From_College = document.getElementById('POA_From_College');
let POA_To_College = document.getElementById('POA_To_College');
let POA_From_Graduate = document.getElementById('POA_From_Graduate');
let POA_To_Graduate = document.getElementById('POA_To_Graduate');
let HL_UE_Elementary = document.getElementById('HL_UE_Elementary');
let HL_UE_Secondary = document.getElementById('HL_UE_Secondary');
let HL_UE_Vocational = document.getElementById('HL_UE_Vocational');
let HL_UE_College = document.getElementById('HL_UE_College');
let HL_UE_Graduate = document.getElementById('HL_UE_Graduate');
let YR_G_Elementary = document.getElementById('YR_G_Elementary');
let YR_G_Secondary = document.getElementById('YR_G_Secondary');
let YR_G_Vocational = document.getElementById('YR_G_Vocational');
let YR_G_College = document.getElementById('YR_G_College');
let YR_G_Graduate = document.getElementById('YR_G_Graduate');
let Scho_AHR_Elementary = document.getElementById('Scho_AHR_Elementary');
let Scho_AHR_Secondary = document.getElementById('Scho_AHR_Secondary'); 
let Scho_AHR_Vocational = document.getElementById('Scho_AHR_Vocational');
let Scho_AHR_College = document.getElementById('Scho_AHR_College');
let Scho_AHR_Graduate = document.getElementById('Scho_AHR_Graduate');
...
let VI_I_D_From = document.getElementById('VID_I_D_From');
let VID_I_D_To = document.getElementById('VID_I_D_To');
...
let O_SSH = document.getElementById('O_SSH');
let O_SSH1 = document.getElementById('O_SSH1');
let O_SSH2 = document.getElementById('O_SSH2');
let O_SSH3 = document.getElementById('O_SSH3');
let O_SSH4 = document.getElementById('O_SSH4');
let O_SSH5 = document.getElementById('O_SSH5');
let O_SSH7 = document.getElementById('O_SSH6');
let O_AR = document.getElementById('O_AR');
let O_AR1 = document.getElementById('O_AR1');
let O_AR2 = document.getElementById('O_AR2');
let O_AR3 = document.getElementById('O_AR3');
let O_AR4 = document.getElementById('O_AR4');
let O_AR5 = document.getElementById('O_AR5');
let O_AR6 = document.getElementById('O_AR6');
let O_MAO = document.getElementById('O_MAO');
let O_MAO1 = document.getElementById('O_MAO1');
let O_MAO2 = document.getElementById('O_MAO2');
let O_MAO3 = document.getElementById('O_MAO3');
let O_MAO4 = document.getElementById('O_MAO4');
let O_MAO5 = document.getElementById('O_MAO5');
let O_MAO6 = document.getElementById('O_MAO6');
...
let C4_Picture = document.getElementById('C4Picture');
...
LADAdd.addEventListener('click', function() {
    ...
    let Conducted_By = document.getElementById("Conducted_By");
    ...
    let newDetail = 	{
        ...
        "Conducted_By" : Conducted_By.value
	};
    ...
    td7.innerText = `${Conducted_By.value}`;
...
Submit.addEventListener('click', () => {
    ...
    let details = {
        ...
        'Father_Firstname' : Father_Firstname.value,
        'Father_NameExtension' : Father_NameExtension.value,
        'Father_Middlename' : Father_Middlename.value,
        'Mother_MaidenName' : Mother_MaidenName.value,
        'Mother_Surname' : Mother_Surname.value,
        'Mother_Firstname' : Mother_Firstname.value,
        'Mother_Middlename' : Mother_Middlename.value,
